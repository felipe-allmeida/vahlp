...
export const conteudo = {
  ...
  motivos: {
    ...
    lista: [
      ...
      'Que eu tenho mais foto tua de língua pra fora do que de foto séria. E que eu não trocaria nenhuma.',
      ...
      'Que eu adoro poder conhecer de tudo contigo. Mesa nova, cidade nova, o que vier.',
      ...
      'Que uma garrafa aberta já melhora o teu dia. E melhora o meu junto.',
      ...
      'O jeito que você deita com o cachorro e faz a mesma cara que ele. E que eu já amo o Antônio, o nosso futuro cachorro.',
      'Que o "a gente ainda não mora junto" é a única linha desta lista que eu quero mudar.',
      'Que o teu lugar preferido tem água na frente. É por isso que este site inteiro está debaixo d\'água.',
